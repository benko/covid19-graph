...
set output "covid19-current-deaths.png"
...
# Y axis is index.
set ylabel "(Cumulative) Number of Deaths per 100k"
set ytics 10, 10
set pointsize 0.3
set grid ytics
set key center top
# Draw style is the same for all, only colour changes.
dstyle = "axis x1y1 with lines smooth cumulative"
# Calculation expression is the same as well.
expr = "using 1:($6 / $10 * 100000)"
#
#           plot {<ranges>}
#                {<iteration>}
